            ...
            switch ($act) {
                ...
                case 'download':
                    ...
                    case 'terkirim':
                        ...
                        // tambahkan data ke tbl_surat_keluar
                        ...
                        // cek apakah data berhasil disimpan ke tbl_surat_keluar
                        if ($query_keluar) {
                            echo '<div class="alert alert-success alert-dismissible fade show text-center" role="alert" style="border-radius: 10px; padding: 20px; font-size: 18px;">
                                    ...
                                    Anda akan diarahkan kembali ke halaman sebelumnya dalam 4 detik.
                                  </div>';
                    
                            // JavaScript untuk auto-back halaman setelah beberapa detik
                            echo '<script>
                                    setTimeout(function() {
                                        window.history.back();
                                    }, 4000); // Auto-back setelah 4 detik
                                  </script>';
                        } else {
